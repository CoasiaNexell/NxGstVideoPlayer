...
LIBS += -L${SDKTARGETSYSROOT}/usr/lib/ -lnx_drm_allocator -lnx_video_api -lnx_renderer
...
INCLUDEPATH += ${SDKTARGETSYSROOT}/usr/include/ ../libnxgstvplayer/include
INCLUDEPATH += ${SDKTARGETSYSROOT}/usr/include/drm
